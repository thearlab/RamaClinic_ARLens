...
//Manually set the time value of a tween 
function setTimeValue(tweenObject, tweenName, timeValue) {
    var tweenScriptComponent = findTween(tweenObject, tweenName);

    if (tweenScriptComponent) {x
...
global.tweenManager.setTimeValue = setTimeValue;
